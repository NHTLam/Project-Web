 ...
 */
final class Version20220621052439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assignment ADD answer VARCHAR(255) DEFAULT NULL, ADD datesubmit DATE DEFAULT NULL, DROP answer_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assignment ADD answer_id INT DEFAULT NULL, DROP answer, DROP datesubmit');
